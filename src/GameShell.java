...
public abstract class GameShell extends Applet implements Runnable, FocusListener, WindowListener {
	...
	protected final synchronized void method201() {
		...
		if (SkeletonSet.staticGraphicsBuffer1 != null) {
			SkeletonSet.staticGraphicsBuffer1.method279(var3.anImage1.getGraphics(), 0, 0);
		}

		SkeletonSet.staticGraphicsBuffer1 = var3;
		staticBool11 = false;
		...
		try {
			...
			label80: while (true) {
				...
				do {
					...
					ItemPile.staticInt33 = Static.staticAbstractClass3_1.method215(staticInt104, staticInt105);

					for (int var10 = 0; var10 < ItemPile.staticInt33; var10++) {
						method210();
					}
