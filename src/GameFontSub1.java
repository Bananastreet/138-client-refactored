public final class GameFontSub1 extends GameFont {

	public GameFontSub1(byte[] var1) {
		super(var1);
	}
	...
	public GameFontSub1(byte[] var1, int[] var2, int[] var3, int[] var4, int[] var5, int[] var6,
			byte[][] var7) {
