...
public class Static {
	...
	static AbstractFileStore staticJs5Index1;
	...
	static RuneScript staticMethod148(int var0) {
		...
		if (var1 != null) {
			...
			if (var3 == null) {
				...
				var1.anInt398 = var4.readUShort();
				var1.anInt399 = var4.readUShort();
				var1.anInt401 = var4.readUShort();
				var1.anInt400 = var4.readUShort();
				var4.position = 0;
				var4.method334();
	...
	public static void staticMethod3(AbstractFileStore var0, AbstractFileStore var1, boolean var2, GameFontSub1 var3) {
	...
	public static GameFontSub1 staticMethod54(AbstractFileStore var0, AbstractFileStore var1, int var2, int var3) {
	...
	public static void staticMethod9(AbstractFileStore var0, AbstractFileStore var1) {
	...
	static boolean staticMethod65(AbstractFileStore var0, int var1, int var2) {
		...
		if (var2 == 25) {
			...
			if (var2 == 1005) {
				...
				if (var17 != null && var17.anIntArray77[var0] >= 100000) {
					staticMethod36(27, "", var17.anIntArray77[var0] + " x " + staticMethod153(var3).name);
				} else {
			...
			if (var2 == 38) {
				...
				Client.staticString32 = staticMethod118(16748608) + staticMethod153(var3).name
				...
				if (Client.staticBool32 && Client.staticBool32) {
					...
					if (var17 != null && var17.anObjectArray12 != null) {
						ScriptEvent var223 = new ScriptEvent();
	...
	static final void staticMethod69(int var0, int var1, int var2, int var3, Picture var4, CacheableSub3 var5) {
	...
	public static FileOnDisk staticMethod70(String var0, String var1, boolean var2) {
		...
		String var4 = "";
		if (ScriptEvent.staticInt314 == 33) {
			var4 = "_rc";
		} else if (ScriptEvent.staticInt314 == 34) {
			var4 = "_wip";
		}
	...
	static NodeSub14 staticMethod86(AbstractFileStore var0, int var1) {
	...
	public static void staticMethod88(AbstractFileStore var0, AbstractFileStore var1, AbstractFileStore var2) {
										...
										for (var16 = 0; var16 < var10.anInt304; var16++) {
											...
											if (var10.anIntArray76[var20] <= 0) {
												if (var10.anIntArray68 != null && var20 < 20) {
													Picture var461 = var10.method384(var20);
													if (var461 != null) {
									...
									if (var10.anInt296 == 4) {
										...
										if (var52 == null) {
											...
											if (var10.aBool42 && var10.anInt352 != -1) {
												...
												if ((var61.stackable == 1 || var10.anInt353 != 1)
														&& var10.anInt353 != -1) {
												...
												for (var16 = 0; var16 < var10.anInt305; var16++) {
													for (var25 = 0; var25 < var10.anInt304; var25++) {
														if (var10.anIntArray76[var23] > 0) {
															...
															if (var17.stackable != 1 && var10.anIntArray77[var23] == 1) {
																var15 = staticMethod118(16748608) + var17.name
																		+ staticString16;
															} else {
																String var44 = staticMethod118(16748608)
																		+ var17.name + staticString16 + " "
																		+ 'x';
							...
							if (var9.anInt296 == 0) {
								...
								if (var29 != null) {
									if (var29.anInt383 == 0 && MouseHandler.staticInt94 >= var21
											...
											&& !Client.staticBool40) {
										for (ScriptEvent var30 = (ScriptEvent) Client.staticClass39_8
												.method195(); var30 != null; var30 = (ScriptEvent) Client.staticClass39_8
														.method193()) {
											if (var30.aBool30) {
												var30.method174();
							...
							if (var9.aBool42) {
								...
								if (!var9.aBool43) {
									if (var9.aBool38 && MouseHandler.staticInt94 >= var21
										...
										for (var291 = (ScriptEvent) Client.staticClass39_8
												.method195(); var291 != null; var291 = (ScriptEvent) Client.staticClass39_8
														.method193()) {
											if (var291.aBool30
	...
	public static void staticMethod30(AbstractFileStore var0, int var1, int var2, int var3, boolean var4) {
		staticInt118 = 1;
	...
	public static void staticMethod164(AbstractFileStore var0) {
			...
			if (!var0.aClass36_3.method162()) {
				...
				for (NodeSub3 var78 = (NodeSub3) var0.aClass36_3
					...
					if (var80 == null) {
						...
						Picture var82 = var81.method529();
						Picture var83 = var81.method528();
						int var84 = 0;
	...
	static final byte[] staticMethod241(byte[] var0) {
		...
		if (var2 < 0 || AbstractFileStore.staticInt138 != 0 && var2 > AbstractFileStore.staticInt138) {
			throw new RuntimeException();
		} else if (var3 == 0) {
			...
			if (var4 < 0 || AbstractFileStore.staticInt138 != 0 && var4 > AbstractFileStore.staticInt138) {
				throw new RuntimeException();
			} else {
				...
				if (var3 == 1) {
					...
					AbstractFileStore.staticGZipDecompressor1.method238(var1, var5);
				}
					...
					if (var1 >= var25 && var2 >= var12 && var1 < var25 + 32 && var2 < 32 + var12) {
						...
						if (var0.anIntArray76[var20] > 0) {
							label321: {
										...
										if (var0.anInt294 != GameObject.staticInt332 || staticInt102 != var20) {
											staticMethod341("Use",
													Client.staticString32 + " " + staticString14 + " "
															+ staticMethod118(16748608) + var4.name,
								...
								String[] var23 = var4.interfaceOptions;
								...
								if (var17) {
									for (var22 = 4; var22 >= 3; --var22) {
										...
										if (var23 != null && var23[var22] != null) {
											...
											staticMethod235(var23[var22], staticMethod118(16748608) + var4.name,
													var18, var4.anInt437, var20, var0.anInt294, var26);
										} else if (var22 == 4) {
											staticMethod235("Drop", staticMethod118(16748608) + var4.name, 37,
								...
								if (var26) {
									staticMethod341("Use", staticMethod118(16748608) + var4.name, 38,
								...
								if (var27 && var23 != null) {
									for (var9 = 2; var9 >= 0; --var9) {
										...
										if (var23[var9] != null) {
											...
											staticMethod235(var23[var9], staticMethod118(16748608) + var4.name,
								...
								if (var23 != null) {
									for (var9 = 4; var9 >= 0; --var9) {
										if (var23[var9] != null) {
											...
											staticMethod341(var23[var9], staticMethod118(16748608) + var4.name,
													var241, var4.anInt437, var20, var0.anInt294);
										}
									}
								}

								staticMethod341("Examine", staticMethod118(16748608) + var4.name, 1005,
										var4.anInt437, var20, var0.anInt294);
							}
						}
					}
	...
	public static SoundEffect staticMethod52(AbstractFileStore var0, int var1, int var2) {
		byte[] var3 = var0.getFile(var1, var2);
							...
							if (staticInt13 == 2) {
								...
								if (var12 == 1 && var1 >= var131 - 75 && var1 <= 75 + var131 && var5 >= var14 - 20
									...
									if (staticString2.length() == 0) {
										setResponse("", "Please enter your username/email address.", "");
										return;
									}
								...
								if (staticInt13 == 4) {
									...
									if (var12 == 1 && var1 >= var11 - 75 && var1 <= 75 + var11 && var5 >= var161 - 20
										...
										if (GZipDecompressor.staticString26.length() != 6) {
											setResponse("", "Please enter a 6-digit PIN.", "");
											return;
										}
	...
	public static final Picture staticMethod140(int var0, int var1, int var2, int var3, int var4, boolean var5) {
		if (var1 == -1) {
			var4 = 0;
		...
		Picture var6;
		if (!var5) {
			var6 = (Picture) ItemDefinition.staticCache9.get(var8);
			if (var6 != null) {
				return var6;
			}
		}
		...
		if (var1 > 1 && var10.countObj != null) {
			...
			for (int var20 = 0; var20 < 10; var20++) {
				if (var1 >= var10.countCo[var20] && var10.countCo[var20] != 0) {
					var19 = var10.countObj[var20];
				}
			}
		...
		if (var191 == null) {
			...
			if (var10.notedTemplate != -1) {
				var201 = staticMethod140(var10.notedID, 10, 1, 0, 0, true);
				if (var201 == null) {
					return null;
				}
			} else if (var10.boughtTemplate != -1) {
				var201 = staticMethod140(var10.boughtLink, var1, var2, var3, 0, false);
				if (var201 == null) {
					return null;
				}
			...
			int var13 = Rasterizer2DSub1.staticIntArray154[var10.xan2d] * var15 >> 16;
			int var14 = Rasterizer2DSub1.staticIntArray159[var10.xan2d] * var15 >> 16;
			var191.method592();
			var191.method600(0, var10.yan2d, var10.zan2d, var10.xan2d, var10.xOffset2d,
					var10.yOffset2d + var191.anInt421 / 2 + var13, var10.yOffset2d + var14);
			if (var10.boughtTemplate != -1) {
				var201.method637(0, 0);
			}
	...
	static void staticMethod114(Component var0, AbstractFileStore var1, AbstractFileStore var2, boolean var3, int var4) {
		if (staticBool2) {
			if (var4 == 4) {
				staticInt13 = 4;
			}
			...
			staticSprite2 = new Picture(titleData, var0);			
	...
	static final void staticMethod116(int var0, int var1, int var2, int var3, Picture var4, CacheableSub3 var5) {
		if (var4 != null) {
	...
	static void staticMethod128() {
		...
		if (Client.staticInt179 == 0) {
			...
			Mob.staticSprite5 = new Picture(512, 512);
				...
				while (true) {
					...
					if (!var24) {
						...
						while (true) {
							...
							Widget var361;
							do {
								var33 = (ScriptEvent) Client.staticClass39_9.method194();
								if (var33 == null) {
									while (true) {
										do {
											var33 = (ScriptEvent) Client.staticClass39_10.method194();
											if (var33 == null) {
												while (true) {
													do {
														var33 = (ScriptEvent) Client.staticClass39_8.method194();
														if (var33 == null) {
															boolean var32 = false;
	...
	public static ItemDefinition staticMethod153(int var0) {
		...
		if (var1 != null) {
			...
			if (var1.notedTemplate != -1) {
				var1.method489(staticMethod153(var1.notedTemplate), staticMethod153(var1.notedID));
			}

			if (var1.boughtTemplate != -1) {
				var1.method490(staticMethod153(var1.boughtTemplate), staticMethod153(var1.boughtLink));
			}
			...
			if (!staticBool4 && var1.members) {
				var1.name = "Members object";
				var1.stockMarket = false;
				var1.options = null;
				var1.interfaceOptions = null;
				var1.anInt443 = -1;
				var1.team = 0;
			}
	...
	static final void staticMethod155(BitBuf var0, int var1, Player player, int var3) {		
		...
		if ((var3 & 0x10) != 0) {
			player.anInt600 = var0.readUShort();
			if (player.anInt600 == '\uffff') {
				player.anInt600 = -1;
			}
		}
		...
		if ((var3 & 0x1) != 0) {
			player.anInt608 = var0.readUShort();
		...
		if ((var3 & 0x200) != 0) {
			player.anInt596 = var0.readUShort();
			var7 = var0.readInt();
		...
		if ((var3 & 0x400) != 0) {
			...
			player.anInt625 = var0.readUShort() + Client.staticInt166;
			player.anInt604 = var0.readUShort() + Client.staticInt166;
			player.anInt627 = var0.readUShort() * -1576115929;
			if (player.aBool82) {
		...
		if (var0.indexOf("%") != -1) {
			...
			for (var2 = 1; var2 <= 5; var2++) {
				while (true) {
					...
					int var4 = InterfaceScripts.staticMethod42(var1, var2 - 1);
					String var6;
					if (var4 < 999999999) {
	...
	static final void processLogin() {		
		try {
			...
			System.out.println(Client.loginStage);			
			...
			if (Client.loginStage == 3) {
				...
				responseCode = Class56.gameConnection.read();
				if (ByteBuf.staticClass19_2 != null) {
					ByteBuf.staticClass19_2.method67();
				}
			...
			if (Client.loginStage == 4) {
				if (Client.inBuffer.position < 8) {
					responseCode = Class56.gameConnection.available();
					if (responseCode > 8 - Client.inBuffer.position) {
						responseCode = 8 - Client.inBuffer.position;
					}

					if (responseCode > 0) {
						Class56.gameConnection.read(Client.inBuffer.buf,
								Client.inBuffer.position, responseCode);
						Client.inBuffer.position += responseCode;
					}
				}
			...
			if (Client.loginStage == 6 && Class56.gameConnection.available() > 0) {
				responseCode = Class56.gameConnection.read();
				if (responseCode == 21 && Client.staticInt165 == 20) {
					Client.loginStage = 7;
				} else if (responseCode == 2) {
					Client.loginStage = 9;
				} else if (responseCode == 15 && Client.staticInt165 == 40) {
					Client.staticInt190 = -1;
					Client.loginStage = 13;
				} else if (responseCode == 23 && Client.staticInt302 < 1) {
					++Client.staticInt302;
					Client.loginStage = 0;
				} else {
					if (responseCode != 29) {
			...
			if (Client.loginStage == 8) {
				Client.staticInt262 = 0;
				setResponse("You have only just left another world.", "Your profile will be transferred in:",
				...
				if (Client.loginStage == 9 && Class56.gameConnection.available() >= 13) {
					...
					Client.inBuffer.position = 0;
					Client.staticInt190 = Client.inBuffer.readUShort();
				...
				if (Client.loginStage == 10) {
					...
					if (Client.loginStage == 11 && Class56.gameConnection.available() >= 2) {
						...
						Class56.gameConnection.read(Client.inBuffer.buf, 0, 2);
						Client.inBuffer.position = 0;
						FileOnDisk.staticInt37 = Client.inBuffer.readUShort();
					...
					if (Client.loginStage == 12 && Class56.gameConnection.available() >= FileOnDisk.staticInt37) {
						...
						setResponse(var12, var15, var191);
						staticMethod396(10);
					}
					...
					if (Client.loginStage != 13) {
						...
						if (Class56.gameConnection.available() >= Client.staticInt190) {
							Class56.gameConnection.read(Client.inBuffer.buf, 0, Client.staticInt190);
							Client.inBuffer.position = 0;
							responseCode = Client.staticInt190;
							Client.outBuffer.position = 0;
							Client.inBuffer.position = 0;
							Client.staticInt191 = -1;
							Client.staticInt270 = 1;
							...
							staticMethod34();
							GPI.initializeGPI(Client.inBuffer);
							if (responseCode != Client.inBuffer.position) {
								throw new RuntimeException();
							}
						}
					}
	...
	static Picture[] staticMethod179(AbstractFileStore var0, int var1, int var2) {
		if (!staticMethod65(var0, var1, var2)) {
			return null;
		} else {
			Picture[] var7 = new Picture[staticInt143];

			for (int var3 = 0; var3 < staticInt143; var3++) {
				Picture var4 = var7[var3] = new Picture();
	...
	public static void staticMethod205(AbstractFileStore var0) {
	...
	static void staticMethod208() {
		if (Client.staticBool32) {
			...
			if (var1 != null && var1.anObjectArray12 != null) {
				ScriptEvent var0 = new ScriptEvent();
				var0.aWidget1 = var1;
	...
	static void showResponse(int responseCode) {		
		if (responseCode == -3) {
			setResponse("Connection timed out.", "Please try using a different world.", "");
		} else if (responseCode == -2) {
			setResponse("", "Error connecting to server.", "");
		} else if (responseCode == -1) {
			setResponse("No response from server.", "Please try using a different world.", "");
		} else if (responseCode == 3) {
			staticInt13 = 3;
		} else if (responseCode == 4) {
			setResponse("Your account has been disabled.", "Please check your message-centre for details.", "");
		} else if (responseCode == 5) {
			setResponse("Your account has not logged out from its last",
					"session or the server is too busy right now.", "Please try again in a few minutes.");
		} else if (responseCode == 6) {
			setResponse("RuneScape has been updated!", "Please reload this page.", "");
		} else if (responseCode == 7) {
			setResponse("This world is full.", "Please use a different world.", "");
		} else if (responseCode == 8) {
			setResponse("Unable to connect.", "Login server offline.", "");
		} else if (responseCode == 9) {
			setResponse("Login limit exceeded.", "Too many connections from your address.", "");
		} else if (responseCode == 10) {
			setResponse("Unable to connect.", "Bad session id.", "");
		} else if (responseCode == 11) {
			setResponse("We suspect someone knows your password.", "Press \'change your password\' on front page.",
					"");
		} else if (responseCode == 12) {
			setResponse("You need a members account to login to this world.",
					"Please subscribe, or use a different world.", "");
		} else if (responseCode == 13) {
			setResponse("Could not complete login.", "Please try using a different world.", "");
		} else if (responseCode == 14) {
			setResponse("The server is being updated.", "Please wait 1 minute and try again.", "");
		} else if (responseCode == 16) {
			setResponse("Too many login attempts.", "Please wait a few minutes before trying again.", "");
		} else if (responseCode == 17) {
			setResponse("You are standing in a members-only area.",
					"To play on this world move to a free area first", "");
		} else if (responseCode == 18) {
			setResponse("Account locked as we suspect it has been stolen.",
					"Press \'recover a locked account\' on front page.", "");
		} else if (responseCode == 19) {
			setResponse("This world is running a closed Beta.", "Sorry invited players only.",
					"Please use a different world.");
		} else if (responseCode == 20) {
			setResponse("Invalid loginserver requested.", "Please try using a different world.", "");
		} else if (responseCode == 22) {
			setResponse("Malformed login packet.", "Please try again.", "");
		} else if (responseCode == 23) {
			setResponse("No reply from loginserver.", "Please wait 1 minute and try again.", "");
		} else if (responseCode == 24) {
			setResponse("Error loading your profile.", "Please contact customer support.", "");
		} else if (responseCode == 25) {
			setResponse("Unexpected loginserver response.", "Please try using a different world.", "");
		} else if (responseCode == 26) {
			setResponse("This computers address has been blocked", "as it was used to break our rules.", "");
		} else if (responseCode == 27) {
			setResponse("", "Service unavailable.", "");
		} else if (responseCode == 31) {
			setResponse("Your account must have a displayname set", "in order to play the game.  Please set it",
					"via the website, or the main game.");
		} else if (responseCode == 32) {
			setResponse("Your attempt to log into your account was", "unsuccessful.  Don\'t worry, you can sort",
					"this out by visiting the billing system.");
		} else if (responseCode == 37) {
			setResponse("Your account is currently inaccessible.", "Please try again in a few minutes.", "");
		} else if (responseCode == 38) {
			setResponse("You need to vote to play!", "Visit runescape.com and vote,", "and then come back here!");
		} else if (responseCode == 55) {
			setResponse("Sorry, but your account is not eligible to", "play this version of the game.  Please try",
					"playing the main game instead!");
		} else {
			if (responseCode == 56) {
				setResponse("Enter the 6-digit code generated by your", "authenticator app.", "");
				staticMethod396(11);
				return;
			}

			if (responseCode == 57) {
				setResponse("The code you entered was incorrect.", "Please try again.", "");
				staticMethod396(11);
				return;
			}

			setResponse("Unexpected server response", "Please try using a different world.", "");
		}
	...
	static int staticMethod221(int var0, RuneScript var1, boolean var2) {
		...
		if (var0 != 1200 && var0 != 1205 && var0 != 1212) {
			...
			var3.anInt325 = var4.xan2d;
			var3.anInt332 = var4.yan2d;
			var3.anInt324 = var4.zan2d;
			var3.anInt329 = var4.xOffset2d;
			var3.anInt330 = var4.yOffset2d;
			var3.anInt334 = var4.zoom2d;
			if (var0 == 1205) {
				var3.anInt337 = 0;
			} else if (var0 == 1212 | var4.stackable == 1) {
				var3.anInt337 = 1;
			} else {
				var3.anInt337 = 2;
			}
	...
	public static void staticMethod236(AbstractFileStore var0) {
					...
					if (var291 != null) {
						for (Item var22 = (Item) var291.method196(); var22 != null; var22 = (Item) var291.method197()) {
							...
							if (Client.staticInt258 == 1) {
								staticMethod341("Use",
										Client.staticString32 + " " + staticString14 + " "
												+ staticMethod118(16748608) + var23.name,
								...
								for (int var29 = 4; var29 >= 0; --var29) {
									if (var28 != null && var28[var29] != null) {
										...
										staticMethod341(var28[var29], staticMethod118(16748608) + var23.name,
												var17, var22.anInt573, var26, var10);
									} else if (var29 == 2) {
										staticMethod341("Take", staticMethod118(16748608) + var23.name, 20,
												var22.anInt573, var26, var10);
									}
								}

								staticMethod341("Examine", staticMethod118(16748608) + var23.name, 1004,
										var22.anInt573, var26, var10);
							}
						}
					}
		...
		try {
			if (Class2.staticClass3_1 == null) {
				...
				if (var4 != null) {
					...
					Class2.staticInt2 = var1.readUShort();
	...
	public static Picture staticMethod296(AbstractFileStore var0, int var1, int var2) {
	...
	public static void staticMethod299(AbstractFileStore var0) {
	...
	public static void staticMethod320(AbstractFileStore var0) {
		Config15.staticJs5Index21 = var0;
	}

	public static void staticMethod321(AbstractFileStore var0, AbstractFileStore var1) {
	...
	static final void decodeMapRegion(boolean var0) {		
		...
		if (!Client.staticBool37) {
			...
			var5 = Client.inBuffer.readUShort();
			var2 = Client.inBuffer.readUShort();
	...
	public static Picture[] staticMethod309(AbstractFileStore var0, String var1, String var2) {
		int var3 = var0.method267(var1);
		int var4 = var0.method268(var3, var2);
		...
		if (Class56.gameConnection == null) {
			...
			try {
				...
				if (Client.staticInt191 == 88) {
					var45 = Client.inBuffer.readUShort();
					var2 = Client.inBuffer.readUByte();
					var3 = Client.inBuffer.readUShort();
				...
				if (Client.staticInt191 == 24) {
					...
					while (Client.inBuffer.position < var45) {
						var48 = Client.inBuffer.readInt();
						var5 = Client.inBuffer.readUShort();
						var6 = Client.inBuffer.readUShort();
				...
				if (Client.staticInt191 == 156) {
					...
					var48 = Client.inBuffer.readUShort();
				...
				if (Client.staticInt191 == 208) {
					...
					var65.anInt4 = Client.inBuffer.readUShort();
					var2 = Client.inBuffer.readInt();
					var65.anInt3 = var2;
					staticMethod396(45);
					Class56.gameConnection.shutdown();
				...
				if (Client.staticInt191 == 129) {
					...
					ObjectDefinition.staticInt322 = Client.inBuffer.readUShort();
				...
				if (Client.staticInt191 == 136) {
					...
					for (var5 = 0; var5 < staticInt149; var5++) {
						...
						var97[var5].anInt217 = Client.inBuffer.readUShort();
				...
				if (Client.staticInt191 == 161) {
					...
					if (Client.staticInt255 == 1) {
						Client.staticInt172 = Client.inBuffer.readUShort();
					}
					...
					if (Client.staticInt255 >= 2 && Client.staticInt255 <= 6) {
						...
						Client.staticInt174 = Client.inBuffer.readUShort();
						Client.staticInt175 = Client.inBuffer.readUShort();
						Client.staticInt176 = Client.inBuffer.readUByte();
					}

					if (Client.staticInt255 == 10) {
						Client.staticInt193 = Client.inBuffer.readUShort();
					}
				...
				if (Client.staticInt191 == 2) {
					...
					if (!var4.aBool42) {
						...
						var4.anInt348 = 4;
						var4.anInt295 = var2;
						var4.anInt325 = var891.xan2d;
						var4.anInt332 = var891.yan2d;
						var4.anInt334 = var891.zoom2d * 100 / var3;
						staticMethod73(var4);
					} else {
						var4.anInt352 = var2;
						var4.anInt353 = var3;
						...
						var4.anInt325 = var891.xan2d;
						var4.anInt332 = var891.yan2d;
						var4.anInt324 = var891.zan2d;
						var4.anInt329 = var891.xOffset2d;
						var4.anInt330 = var891.yOffset2d;
						var4.anInt334 = var891.zoom2d;
						if (var891.stackable == 1) {
							var4.anInt337 = 1;
						} else {
							var4.anInt337 = 2;
						}
				...
				if (Client.staticInt191 == 31) {
					Client.staticInt170 = Client.inBuffer.readUShort() * 30;
					Client.staticInt283 = Client.staticInt274 * 2073400987;
					Client.staticInt191 = -1;
					return true;
				}
	...
	static void setResponse(String var0, String var1, String var2) {		
		staticString4 = var0;
		staticString1 = var1;
		staticString6 = var2;
	}
	...
	static void staticMethod314() {
		staticString2 = staticString2.trim();
		if (staticString2.length() == 0) {
			setResponse("Please enter your username.", "If you created your account after November",
					"2010, this will be the creation email address.");
		} else {
			...
			switch (var0) {
			case 2:
				setResponse("", "Page has opened in a new window.", "(Please check your popup blocker.)");
				staticInt13 = 6;
				break;
			case 3:
				setResponse("", "Error connecting to server.", "");
				break;
			case 4:
				setResponse("The part of the website you are trying", "to connect to is offline at the moment.",
						"Please try again later.");
				break;
			case 5:
				setResponse("Sorry, there was an error trying to", "log you in to this part of the website.",
						"Please try again later.");
				break;
			case 6:
				setResponse("", "Error connecting to server.", "");
				break;
			case 7:
				setResponse("You must enter a valid login to proceed. For accounts",
	...
	static final boolean staticMethod318(Widget var0) {
		if (var0.anIntArray73 == null) {
			...
			for (int var1 = 0; var1 < var0.anIntArray73.length; var1++) {
				int var2 = InterfaceScripts.staticMethod42(var0, var1);
	...
	static final void staticMethod345() {
		...
		if (Client.staticInt191 == 29) {
			...
			var32 = Client.inBuffer.readUShort();
			...
			var291 = Client.inBuffer.readUShort();
			var30 = Client.inBuffer.readUByte() * 4;
			var10 = Client.inBuffer.readUByte() * 4;
			var15 = Client.inBuffer.readUShort();
			var18 = Client.inBuffer.readUShort();
	...
	static boolean staticMethod290(AbstractFileStore var0) {
	...
	static NodeSub5 staticMethod291(AbstractFileStore var0, int var1, int var2) {
	...
	static void staticMethod375(ScriptEvent var0) {
	...
	static final void staticMethod391() {
		for (int var0 = 0; var0 < Client.staticInt188; var0++) {
			...
			if ((var5 & 0x10) != 0) {
				var1.anInt600 = Client.inBuffer.readUShort();
				if (var1.anInt600 == '\uffff') {
					var1.anInt600 = -1;
				}
			}
					...
					if (var0 < 3200) {
						...
						if (var0 < 3500) {
							...
							if (var0 == 3400) {
								...
								if (var261 != null) {
									staticStringArray1[++staticInt148 - 1] = var261.defaultString;
								}
								...
								var261 = var27;
								if (var27.keyType == var14 && var19 == var27.valType) {
									...
									if (var261 != null) {
										if (var19 == 115) {
											...
											staticIntArray16[++staticInt27 - 1] = var261.defaultInt;
										}
									}
							...
							if (var0 < 4300) {
								if (var0 == 4200) {
									...
									if (var0 == 4201) {
										...
										if (var19 >= 1 && var19 <= 5 && var391.options[var19 - 1] != null) {
											staticStringArray1[++staticInt148
													- 1] = var391.options[var19 - 1];
										} else {
											staticStringArray1[++staticInt148 - 1] = "";
										}
										...
										var19 = staticIntArray16[1 + staticInt27];
										var391 = staticMethod153(var14);
										if (var19 >= 1 && var19 <= 5 && var391.interfaceOptions[var19 - 1] != null) {
											staticStringArray1[++staticInt148
													- 1] = var391.interfaceOptions[var19 - 1];
										} else {
											staticStringArray1[++staticInt148 - 1] = "";
										}
										...
										var14 = staticIntArray16[--staticInt27];
										staticIntArray16[++staticInt27
												- 1] = staticMethod153(var14).cost;
										var8 = 1;
									} else if (var0 == 4204) {
										var14 = staticIntArray16[--staticInt27];
										staticIntArray16[++staticInt27
												- 1] = staticMethod153(var14).stackable == 1 ? 1 : 0;
										var8 = 1;
									} else {
										...
										if (var0 == 4205) {
											...
											if (var36.notedTemplate == -1 && var36.notedID >= 0) {
												staticIntArray16[++staticInt27 - 1] = var36.notedID;
											} else {
											...
											var14 = staticIntArray16[--staticInt27];
											var36 = staticMethod153(var14);
											if (var36.notedTemplate >= 0 && var36.notedID >= 0) {
												staticIntArray16[++staticInt27 - 1] = var36.notedID;
											} else {
												staticIntArray16[++staticInt27 - 1] = var14;
											}
											...
											var14 = staticIntArray16[--staticInt27];
											staticIntArray16[++staticInt27
													- 1] = staticMethod153(var14).members ? 1 : 0;
											var8 = 1;
										} else if (var0 == 4208) {
											var14 = staticIntArray16[--staticInt27];
											var36 = staticMethod153(var14);
											...
											while (true) {
												...
												if (var31 >= KeyboardHandler.staticInt85) {
													...
													for (var11 = 0; var11 < staticInt114; var11++) {
														var34[var11] = staticMethod153(var32[var11]).name;
													}
												...
												if ((!var9 || var33.stockMarket) && var33.notedTemplate == -1
														&& var33.name.toLowerCase().indexOf(var17) != -1) {
													if (var7 >= 250) {
														staticInt114 = -1;
	...
	static int staticMethod389(AbstractFileStore var0, AbstractFileStore var1) {
		int var2 = 0;
	...
	public static void staticMethod397(AbstractFileStore var0, AbstractFileStore var1) {
	...
	static void staticMethod385(byte[] var0) {
		...
		staticInt139 = var1.readUShort();
		staticInt142 = var1.readUShort();
		...
		for (var3 = 0; var3 < staticInt143; var3++) {
			staticIntArray69[var3] = var1.readUShort();
		}

		for (var3 = 0; var3 < staticInt143; var3++) {
			staticIntArray72[var3] = var1.readUShort();
		}

		for (var3 = 0; var3 < staticInt143; var3++) {
			staticIntArray71[var3] = var1.readUShort();
		}
	...
	public static GameFontSub1 staticMethod386(AbstractFileStore var0, AbstractFileStore var1, String var2, String var3) {
	...
	static Picture staticMethod429() {
		Picture var0 = new Picture();
	...
	public static EntitySub3 staticMethod434(AbstractFileStore var0, int var1, int var2) {
		byte[] var3 = var0.getFile(var1, var2);
	...
	static Picture[] staticSpriteArray2;
	...
	public static AbstractFileStore staticJs5Index3;
	public static AbstractFileStore staticJs5Index4;
	public static AbstractFileStore staticJs5Index5;
	...
	public static AbstractFileStore staticJs5Index6;
	public static int staticInt118 = 0;
	public static int staticInt120;
	static Picture[] staticSpriteArray3;
	...
	static Picture[] staticSpriteArray4;
	...
	static Picture[] staticSpriteArray5;
	...
	static AbstractFileStore staticJs5Index8;
